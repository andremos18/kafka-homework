...
public class KafkaStreamsConfig {
    ...
    @Bean
    public KafkaAdmin adminClient(EventStoreProperties eventStoreProperties) {
        Map<String, Object> props = eventStoreProperties.getKafka().buildAdminProperties(null);
